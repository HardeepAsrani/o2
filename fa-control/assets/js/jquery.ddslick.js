...
(function ($) {
    ...
    ddslickCSS = '<style id="css-ddslick" type="text/css">' +
                ...
                '.dd-option-icon, .dd-selected-icon { width:36px; text-align:center; vertical-align:middle; float:left; margin-right:10px; font-family:FontAwesome; font-size:34px;}' +
                ...
                $.each(options.data, function (index, item) {
                    ...
                    ddOptions.append('<li>' +
                        '<a class="dd-option">' +
                            ...
                            (item.iconSrc ? ' <i class="dd-option-icon'  + (options.iconPosition == "right" ? ' dd-icon-right' : '') + ' fa ' + item.iconSrc + '" ></i>' : '') +
    ...
    function selectIndex(obj, index) {
        ...
        if (settings.showSelectedHTML) {
            ddSelected.html(
					(selectedData.iconSrc ? '<i class="dd-selected-icon' + (settings.iconPosition == "right" ? ' dd-icon-right' : '') + ' fa ' + selectedData.iconSrc + '" ></i>' : '') +
